...
scoring::identify_round_winners(const std::vector<PlayerHuman>& players)
{
...
std::vector<std::size_t>
scoring::identify_winners(const std::vector<PlayerHuman>& players)
{
...
void scoring::display_scores(const std::vector<PlayerHuman>& players)
{
